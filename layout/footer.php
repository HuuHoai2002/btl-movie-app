  ...
  <div class="app-footer-content">
    ...
    <div class="footer-grid">
      <div class="footer-item">
        <div class="list-info">
          <p class="info">
            Movie App là dịch vụ được cung cấp bởi nhóm 5, thành viên của Trường Đại Học Mỏ Địa Chất (HUMG)
          </p>
          <p class="info">
            18 P. Viên, Đông Ngạc, Bắc Từ Liêm, Hà Nội 100000
          </p>
          <p class="info">
          ...
          <p class="info"> Nơi cấp: Sở kế hoạch và đầu tư thành phố Hà Nội.</p>
        </div>
        <img class="footer__informed" src="https://assets.glxplay.io/web/responsive/w200/informed.png" alt="informed">
      </div>
      <div class="footer-item">
        <div class="heading">
          <h3>GIỚI THIỆU</h3>
          <div class="list-link">
            ...
            <a href="" class="link">Chính sách bảo mật</a href="">
            <a href="" class="link">Khuyến mãi</a href="">
          </div>
        </div>
      </div>
      <div class="footer-item">
        <div class="heading">
          ...
          <div class="list-link">
            ...
            <a href="" class="link">movieapp@gmail.com</a>
            <a href="" class="link">https://movieapp.vn/help</a>
          </div>
        </div>
      </div>
      <div class="footer-item">
        <div class="heading">
          <h3>THÀNH VIÊN</h3>
          <div class="list-link">
            <a href="" class="link">Nghiêm Hữu Hoài</a>
            <a href="" class="link">Nguyễn Hữu Hòa</a>
            <a href="" class="link">Đào Hữu Long</a>
            <a href="" class="link">Nguyễn Hoàng Hiệp</a>
          </div>
        </div>
        <div class="heading" style="margin-top: 20px">
          <h3>KẾT NỐI VỚI CHÚNG TÔI</h3>
          <div class="list-image">
            <img src="./assets/image/facebook.png" class="link-image" alt="">
            <img src="./assets/image/tik-tok.png" class="link-image" alt="">
            <img src="./assets/image/instagram.png" class="link-image" alt="">
            <img src="./assets/image/youtube.png" class="link-image" alt="">
          </div>
        </div>
      </div>
    </div>
